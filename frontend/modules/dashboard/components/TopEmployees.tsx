...
export function TopEmployees(props: Readonly<{
  ...
  const { loading, topNInput, setTopNInput, handleTopNBlur, topRidersOverall, topRidersPerApp } = props;
  return (
            ...
            <div>
              ...
              <div className="space-y-2">
                {topRidersOverall.map((r) => (
                  <div key={`${r.name}-${r.appId}`} className="flex items-center justify-between rounded-xl px-3 py-2.5 hover:bg-muted/40">
